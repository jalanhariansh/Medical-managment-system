"""
Django settings for SUTT_task project.
...
SECRET_KEY = 'django-insecure-eqlu=*y8$!uje1ryxn+h3&^fm!*mknpmi1*qtr7$&c!(h1edxk'
...
WSGI_APPLICATION = 'SUTT_task.wsgi.application'
